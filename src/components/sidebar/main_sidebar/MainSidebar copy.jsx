        ...
        <div className="sidebar">
...

          {
            navItems?.map((item, index) => {
              ...
              } else if (isMainMenu && !isMobileView) {
                if (item.isMobile) {
          ...
          }
          {
            isMobileView &&
            <>
              <CustomButton label='Login' variant='transparent' />
              <CustomButton label='Create an account' variant='primary' />
            </>
          }
        </div>
      </div>
