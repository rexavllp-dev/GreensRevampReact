...
import { cancelIndividualOrder, cancelOrder, updateOrderQuantity } from "@/services/features/orderSlice";
    ...
    return (
        ...
        >
            <ModalContent>
                {(handleClose) => (
                    <>
                        <ModalHeader className="flex flex-col gap-1">Cancel Order</ModalHeader>
                        <ModalBody>
