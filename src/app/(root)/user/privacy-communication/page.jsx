...
import "./PrivacyCommunication.scss"
...
const PrivacyCommunication = () => {
    ...
    return (
        <div className="privacy_communication_section">
            <div className="header mb-3">
                <div className="flex gap-3">
                    <div className="cursor-pointer" onClick={() => router.back()}>
                        <MdKeyboardArrowLeft size={32} />
                    </div>
                    <CustomTypography content={'Communication & Privacy'} weight="BOLD" color="BLACK" size="SUPER-LARGE" />
                </div>
            </div>
...
export default PrivacyCommunication