        ...
        <div className="homepage-tile-container">
            ...
            <div className="homepage-tile-webview">
                <div className="section-one">
                    <ImageCard title={'Cake Toppers'} img={imageUrl + '/images/tile1.png'} buttonText={getTranslation('shop_now_btn')} cardHeight={"300px"} cardWidth={"100%"} />
                    <ImageCard title={'Edibles'} img={imageUrl + '/images/homewall2.png'} buttonText={getTranslation('shop_now_btn')} cardHeight={"612px"} cardWidth={"100%"} />
                    <ImageCard title={'Feves'} img={imageUrl + '/images/tile7.png'} buttonText={getTranslation('shop_now_btn')} cardHeight={"300px"} cardWidth={"100%"} />
                </div>
                <div className="section-two">
                    <ImageCard title={'Hello Christmas'} img={imageUrl + '/images/homewall1.png'} buttonText={getTranslation('explore_btn')} cardHeight={"394px"} cardWidth={'100%'} />
                    <div className="subsection-one">
                        <div className="leftsection">
                            <ImageCard title={'Cellphane Cookie Bags'} img={imageUrl + '/images/tile4.png'} buttonText={getTranslation('explore_btn')} cardHeight={"250px"} cardWidth={'100%'} />
                        </div>
                        <div className="rightsection">
                            <ImageCard title={'Cake Mixes'} img={imageUrl + '/images/tile5.png'} buttonText={getTranslation('explore_btn')} cardHeight={"250px"} cardWidth={'100%'} />
                        </div>
                    </div>
                    <div className="subsection-two">
                        <ImageCard title={'Loyalty points on every purchase *'} img={imageUrl + '/images/tile6.png'} buttonText={getTranslation('signup')} cardHeight={"250px"} cardWidth={'100%'} />
                        <ImageCard title={'Christmas Panettone'} img={imageUrl + '/images/tile8.png'} buttonText={getTranslation('shop_now_btn')} cardHeight={"300px"} cardWidth={"100%"} />
                    </div>

                </div>
                <div className="section-three">
                    <ImageCard title={'Decoration Stamps'} img={imageUrl + '/images/tile2.png'} buttonText={getTranslation('shop_now_btn')} cardHeight={"300px"} cardWidth={"100%"} />
                    <ImageCard title={'Wrap your Gifts'} img={imageUrl + '/images/tile3.png'} buttonText={getTranslation('shop_now_btn')} cardHeight={"612px"} cardWidth={"100%"} />
                    <ImageCard title={'Silicone Moulds'} img={imageUrl + '/images/tile9.png'} buttonText={getTranslation('shop_now_btn')} cardHeight={"300px"} cardWidth={"100%"} />
                </div>
            </div>
