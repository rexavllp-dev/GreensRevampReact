...
import RecipeCategoryModal from '@/components/modal/admin/RecipeCategoryModal';
    ...
    return (
        ...
        <div className='transactions-wrapper'>
            ...
            <div className="title">
                ...
                <CustomTypography content={"Recipe Category"} weight="BOLD" color="BLACK" size="SUPER-LARGE" />
            </div>
            ...
            <div className="header">
                ...
                <div className="right">
                    ...
                    <CustomButton label="Create Category" variant="primary" height={'42px'}
