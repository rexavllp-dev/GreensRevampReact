...
import "./Returns.scss";
import { getAllOrdersByAdmin, getAllReturnsByAdmin } from '@/services/features/orderSlice';
...
const Returns = () => {
    ...
    const { allReturnsByAdmin } = useSelector((state) => state.order);

    const [searchQuery, setSearchQuery] = React.useState('');

    React.useEffect(() => {
        dispatch(getAllReturnsByAdmin({}))
    }, [])
    ...
    return (
        <div className='returns-wrapper'>
            ...
            <div className="title">
                ...
                <CustomTypography content={"Returned Orders"} weight="BOLD" color="BLACK" size="SUPER-LARGE" />
            </div>
            ...
            <CustomTable columnDefs={columnDefs} rowData={allReturnsByAdmin?.result}
