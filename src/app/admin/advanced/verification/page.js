    ...
    return (
        <div className="adminverification">
            ...
            <div className="title">
                ...
                <CustomTypography content={"Verification"} weight="BOLD" color="BLACK" size="SUPER-LARGE" />
            </div>
            ...
            {/* <Documents url={'https://greensecombucket.s3.ap-south-1.amazonaws.com/images/dummy1.pdf'}/> */}
